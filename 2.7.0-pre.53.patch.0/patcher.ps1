<#
.SYNOPSIS
    Cursor Layout Menu Patcher for 2.7.0-pre.53 - Restores the full "Change Layout" menu.

.DESCRIPTION
    Patches workbench.desktop.main.js for Cursor 2.7.0-pre.53.
    Pre.53 variables: P9w (2 layouts), ch (clear), NL/O9w (opener), fL (cmd), Ci (StorageScope), V0 (layoutEnum).
#>
...
$Patches = @(
    ...
    @{
        ...
        AllowLengthMismatch = $true
        Search  = '{getAnchor:()=>$,anchorAlignment:1,anchorPosition:0,layer:-24,render:q=>{try{const G=NL(a,u)?_:void 0;return i.createInstance(O9w'
        Replace = '{getAnchor:()=>$,anchorAlignment:1,anchorPosition:0,render:q=>{try{const G=NL(a,u)?_:void 0;return i.createInstance(O9w'
    },
    @{
        Name                = "buildContent_full_pre53"
        AllowLengthMismatch = $true
...
function Invoke-Patch {
    Write-ColorOutput "=== Cursor Layout Patcher (2.7.0-pre.53) ===" "Cyan"
