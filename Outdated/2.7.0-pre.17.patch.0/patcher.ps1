<#
.SYNOPSIS
    Cursor Layout Menu Patcher for 2.7.0-pre.17 - Restores the full "Change Layout" menu.

.DESCRIPTION
    Patches workbench.desktop.main.js for Cursor 2.7.0-pre.17.
    Pre.17 variables: $Dw (2 layouts, Zen+Browser injected via spread), rh (clear),
    C( (i18n), q0 (layout enum), h4/WDw (opener), nL (Cursor Settings cmd), Ei (StorageScope).
#>
...
# 2.7.0-pre.17: $Dw=2 layouts, inject Zen+Browser; q0=enum, h4/WDw=opener, Ei=StorageScope, nL=cmd
$Patches = @(
    @{
        Name                = "getDefaultLayouts_4layouts"
        AllowLengthMismatch = $true
        Search  = 'getDefaultLayouts(){return $Dw}'
        Replace = 'getDefaultLayouts(){return[...$Dw,{id:"default-zen",name:C(3183,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!0,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"},{id:"default-browser",name:C(3184,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!1,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"}]}'
    },
    @{
        Name                = "renderModeGrid_pre17"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "appendCursorSettingsButton_keybinding_pre17"
        AllowLengthMismatch = $true
...
function Invoke-Patch {
    Write-ColorOutput "=== Cursor Layout Patcher (2.7.0-pre.17) ===" "Cyan"
