...
.DESCRIPTION
    ...
    Zen E(3212), Browser E(3092); avoid E(3091) Layout+Zen. Agent/Editor E(3072)/E(3073). Settings label E(3069).
...
$Patches = @(
    @{
        ...
        Replace = 'getDefaultLayouts(){return[...yIS,{id:"default-zen",name:E(3212,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!0,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"},{id:"default-browser",name:E(3092,null),state:{agentsVisible:!1,chatVisible:!0,editorsVisible:!0,panelVisible:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{},panelMaximized:!1},type:"default"}]}'
    },
    @{
