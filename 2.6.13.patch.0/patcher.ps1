<#
.SYNOPSIS
    Cursor Layout Menu Patcher for 2.6.13 - Restores the full "Change Layout" menu
    (Agent, Editor, Zen, Browser + all toggles).

.DESCRIPTION
    Patches the workbench.desktop.main.js in-place for Cursor 2.6.13 (stable).
    Restores Zen/Browser presets and individual toggle switches.
    2.6.13 uses: yyw (2 layouts, Zen+Browser via spread), th, M0, wi, HP, UF, kyw.
#>
...
# 2.6.13 patches. yyw=2 layouts (no K2a), inject Zen+Browser via spread. th=clear, M0=layout enum, wi=StorageScope, HP=cmd, UF/kyw=opener.
$Patches = @(
    @{
        Name                = "getDefaultLayouts_4layouts"
        AllowLengthMismatch = $true
        Search  = 'getDefaultLayouts(){return yyw}'
        Replace = 'getDefaultLayouts(){return[...yyw,{id:"default-zen",name:_(3183,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!0,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"},{id:"default-browser",name:_(3184,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!1,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"}]}'
    },
    @{
        Name                = "renderModeGrid_2613"
        AllowLengthMismatch = $true
    ...
    @{
        ...
        AllowLengthMismatch = $true
        Search  = '{getAnchor:()=>$,anchorAlignment:1,anchorPosition:0,layer:-24,render:H=>{try{const W=UF(a,u)?C:void 0;return i.createInstance(kyw'
        Replace = '{getAnchor:()=>$,anchorAlignment:1,anchorPosition:0,render:H=>{try{const W=UF(a,u)?C:void 0;return i.createInstance(kyw'
    },
    @{
        Name                = "buildContent_full_2613"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "appendCursorSettingsButton_keybinding_2613"
        AllowLengthMismatch = $true
...
function Invoke-Patch {
    Write-ColorOutput "=== Cursor Layout Patcher (2.6.13) ===" "Cyan"
